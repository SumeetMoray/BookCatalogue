...
public class FavouriteBookAdapter extends RecyclerView.Adapter<FavouriteBookAdapter.ViewHolder>{
    ...
    public FavouriteBookAdapter(List<Book> dataset, Context context) {
    ...
    @Override
    public FavouriteBookAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_item_favourite_book,parent,false);
    ...
    @Override
    public void onBindViewHolder(FavouriteBookAdapter.ViewHolder holder, final int position) {
