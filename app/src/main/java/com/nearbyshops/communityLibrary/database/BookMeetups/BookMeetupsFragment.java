...
import com.nearbyshops.communityLibrary.database.ModelEndpoint.BookMeetupEndpoint;
...
import static com.nearbyshops.communityLibrary.database.BookMeetups.BookMeetupsActivity.SORT_BY_DISTANCE;

public class BookMeetupsFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener, NotifySort {

    private static final String TAG = "communitylibrarylog";
...
//        reviewsList.addItemDecoration(new DividerItemDecoration(this,DividerItemDecoration.HORIZONTAL_LIST));
        ...
        // 550 for high density and 350 for low density
    }
