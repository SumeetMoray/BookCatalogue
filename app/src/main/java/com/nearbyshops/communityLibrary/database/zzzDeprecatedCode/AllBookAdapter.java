package com.nearbyshops.communityLibrary.database.zzzDeprecatedCode;
...
public class AllBookAdapter extends RecyclerView.Adapter<AllBookAdapter.ViewHolder>{
    ...
    public void onBindViewHolder(AllBookAdapter.ViewHolder holder, final int position) {
        ...
        {
            holder.bookTitle.setText(R.string.book_title_not_set);
        ...
        if(rating_count == 0)
        {
            holder.bookRating.setText(R.string.book_rating_not_available);
